package com.mperfit.perfit.ui.activities.fragment;
...
public class ActivityFragment extends BaseFragment<ActivityPresenterImpl> implements ActivityContract.View, OnRefreshListener, OnLoadMoreListener {
    @BindView(R.id.tb_activity_toolbar)
    Toolbar mToolBar;
    ...
    protected void initEventAndData() {
        ...
        activityAdapter = new ActivityAdapter(mContext, list);
    ...
    public void showContent(final ActivityBean activityBean) {
        ...
        if (activityBean.getCode() == 100) {
            ...
            activityAdapter.addActivityData(activityBean);
        } else {
        ...
        activityAdapter.setOnItemClickListener(new ActivityAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View view) {
                ...
                intent.putExtra("id", activityBean.getData().getList().get(position).getActivity_id());
...
//                }
    ...
    public void showMoreContent(ActivityBean activityBean) {
        ...
        if (activityBean.getCode() == 100) {
            activityAdapter.addActivityMoreData(activityBean);
