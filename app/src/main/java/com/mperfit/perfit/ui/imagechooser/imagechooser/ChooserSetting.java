...
import com.mperfit.perfit.ui.imagechooser.imagechooser.res.CircleChooseDrawable;
...
public class ChooserSetting{
    ...
    /**标题的背景颜色*/
    public static int TITLE_COLOR=R.color.white;
    ...
    /**选中图片的滤镜颜色*/
    public static int chooseFilter=0x99000000;
    ...
    /**临时文件存储位置*/
    public static String tempFolder= Environment.getExternalStorageDirectory().getAbsolutePath()+"/Perfit/";
