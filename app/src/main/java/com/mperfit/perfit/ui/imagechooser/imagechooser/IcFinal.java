...
public class IcFinal {
    ...
    public static final String CHOOSE_TYPE ="ic_final_type";
    public static final String TYPE_RELEASE="ic_final_type_release";
    public static final String TYPE_CROP="ic_final_type_CROP";
    public static final String TYPE_MULTIPLE_CHOICE="ic_final_type_multiple_choice";

    public static final String ACTION_ALBUM="android.intent.action.perfit.album";
    public static final String ACTION_CROP="android.intent.action.perfit.crop";
