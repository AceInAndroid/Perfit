...
public class RefundFragment extends SimpleFragment implements OnLoadMoreListener {
    ...
    private void getData() {
        Subscription subscription = retrofitHelper.fetchOrederList(1, 5)
    ...
    public void onLoadMore() {
        if (currentPage <= totalPage) {
            retrofitHelper.fetchOrederList(currentPage,5)
                    .compose(RxUtil.<OrderListBean>rxSchedulerHelper())
                    .subscribe(new Action1<OrderListBean>() {
                        @Override
                        public void call(OrderListBean orderListBean) {
