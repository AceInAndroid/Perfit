...
public class UnpaidFragment extends SimpleFragment implements OnLoadMoreListener {
    ...
    private void getData() {
        Subscription subscription = retrofitHelper.fetchOrederList(1, 1)
    ...
    public void onLoadMore() {
        if (currentPage <= totalPage) {
            retrofitHelper.fetchOrederList(currentPage,1)
                    .compose(RxUtil.<OrderListBean>rxSchedulerHelper())
                    .subscribe(new Action1<OrderListBean>() {
                        @Override
                        public void call(OrderListBean orderListBean) {
