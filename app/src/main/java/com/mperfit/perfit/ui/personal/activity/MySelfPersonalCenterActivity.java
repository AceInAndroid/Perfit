...
/**
 * Created by zhangbing on 2017/2/26.
 */

public class MySelfPersonalCenterActivity extends BaseActivity<NewPersonalPresenterImpl> implements NewPersonalContract.View, OnRefreshListener {
    ...
    protected int getLayout() {
        return R.layout.activity_my_self_personal_center;
    }
        ...
        appDetailBar.addOnOffsetChangedListener(new AppBarStateChangeListener() {
            ...
            public void onStateChanged(AppBarLayout appBarLayout, State state) {
                ...
                if (state == State.EXPANDED) {
                    ...
                    ibBack.setBackground(getResources().getDrawable(R.drawable.my_btn_back_black));
                    ibSet.setBackground(getResources().getDrawable(R.drawable.my_btn_seted));
                } else {
                    //中间状态
                    ibBack.setBackground(getResources().getDrawable(R.drawable.myself_return_white));
