package com.mperfit.perfit.widget.alert;
...
/**
 * 封装的ios风格的提示框
 * Created by zhangbing on 2016/12/12.
 */
...
public class CustomAlertView extends View {
    ...
    // 配置标题
    public void baseConfiguration(String title) {
        alertTitle.setText(title);
        alertContent.setVisibility(GONE);
    }
    ...
    public void showAlert() {
        ...
        layoutParams.width = (int)(display.getWidth() * 4 / 5);
