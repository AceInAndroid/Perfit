...
public class AutoFitLinearLayoutManager  extends LinearLayoutManager {
    ...
    public AutoFitLinearLayoutManager(Context context) {
        super(context);
    }

    @SuppressWarnings("UnusedDeclaration")
    public AutoFitLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        Logger.e("RecyclerView state:" + state.toString());
